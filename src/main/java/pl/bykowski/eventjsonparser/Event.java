...
public class Event {
    ...
    public String toString() {
        return "Event{" +
                ...
                ", showPickASeat=" + showPickASeat +
                ", showSeatmapThumbnail=" + showSeatmapThumbnail +
                ", showColorsInSeatmapThumbnail=" + showColorsInSeatmapThumbnail +
                ", source='" + source + '\'' +
                ", isFree=" + isFree +
                ", version='" + version + '\'' +
                ", summary='" + summary + '\'' +
                ...
                ", isExternallyTicketed=" + isExternallyTicketed +
                ", venue=" + venue +
                ", logo=" + logo +
